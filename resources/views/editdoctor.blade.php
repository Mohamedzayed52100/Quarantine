...
<body>
  <div class="container">
    <div class="row">
        ...
        <div class="card-body">
            <a href="/alldoctor" class="btn btn-success"> all Doctor</a>
            ...
            <form action="/updatedoctor" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <img id="previewImg" src="{{asset('image')}}/{{$d->doc_image   }}" style="max-width: 130px;margin-top: 20px" alt="profil Image">
                </div>
