  ...
  <div class="container">
    <div class="row">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
              <label for="day">Days of work </label>
              <input type="text"  name="day" value="{{  $nurse->days_of_work  }}" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <img id="previewImg" src="{{asset('images')}}/{{$nurse->nur_image   }}" style="max-width: 130px;margin-top: 20px" alt="profil Image">
              </div>
