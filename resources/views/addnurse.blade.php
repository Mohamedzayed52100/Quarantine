  ...
  <div class="container">
    <div class="row">
        ...
        <div class="card-body">
          ...
          @endif
            <form action="{{ route('store.nurse') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  <label for="day">Days of works </label>
                  <input type="test"  name="day" class="form-control">
                </div>
                ...
                <a href="/allnurse" class="btn btn-success">All Nurses</a>
              </form>
        </div>
    </div>
</div>
